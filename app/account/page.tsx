        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 !text-black !opacity-100 outline-none transition placeholder:!text-gray-400 focus:border-black"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-gray-300 bg-white px-4 py-3 !text-black !opacity-100 outline-none transition placeholder:!text-gray-400 focus:border-black"
            />
          </div>
